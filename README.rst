...
User output [short data] example on `Twitter <https://twitter.com/guelfoweb/status/664763793340276736>`_. For JSON output [full data] you can see this paste on `Pastebin <http://pastebin.com/m17vjwF9/>`_.
